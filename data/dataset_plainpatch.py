...
class DatasetPlainPatch(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        self.num_patches_per_image = (
            opt["num_patches_per_image"] if opt["num_patches_per_image"] else 40
        )
        ...
        assert (
            self.paths_L
        ), "Error: L path is empty. This dataset uses L path, you can use dataset_dnpatchh"
    ...
    def get_patches(self, index):
        ...
        for _ in range(num):
            ...
            L_patch = img_L[
                rnd_h : rnd_h + self.path_size, rnd_w : rnd_w + self.path_size, :
            ]
            H_patch = img_H[
                rnd_h : rnd_h + self.path_size, rnd_w : rnd_w + self.path_size, :
            ]
