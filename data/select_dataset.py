...
def define_Dataset(dataset_opt):
    ...
    elif dataset_type in ["solafune"]:
        from data.dataset_solafune import DatasetSolafune as D
    ...
    # -----------------------------------------
        ...
        from data.dataset_video_train import \
            VideoRecurrentTrainVimeoDataset as D
    elif dataset_type in ["videorecurrenttrainvimeovfidataset"]:
        from data.dataset_video_train import \
            VideoRecurrentTrainVimeoVFIDataset as D
        ...
        from data.dataset_video_test import \
            SingleVideoRecurrentTestDataset as D
