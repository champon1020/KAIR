...
class VideoRecurrentTestDataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        self.sigma = (
            opt["sigma"] / 255.0 if "sigma" in opt else 0
...
class VFI_DAVIS(data.Dataset):
    ...
    def __init__(self, data_root, ext="png"):
        ...
        for label_id in os.listdir(self.data_root):
            ...
            ctg_imgs_ = [
                os.path.join(self.data_root, label_id, img_id) for img_id in ctg_imgs_
            ]
        ...
        self.transforms = transforms.Compose(
            [transforms.CenterCrop((480, 840)), transforms.ToTensor()]
        )
