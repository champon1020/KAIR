...
def define_D(opt):
    ...
    if net_type == "discriminator_vgg_96":
        from models.network_discriminator import \
            Discriminator_VGG_96 as discriminator
    ...
    # ----------------------------------------
        ...
        from models.network_discriminator import \
            Discriminator_VGG_128 as discriminator
    ...
    # ----------------------------------------
        ...
        from models.network_discriminator import \
            Discriminator_VGG_192 as discriminator
    ...
    # ----------------------------------------
        ...
        from models.network_discriminator import \
            Discriminator_PatchGAN as discriminator
        ...
        from models.network_discriminator import \
            Discriminator_UNet as discriminator
